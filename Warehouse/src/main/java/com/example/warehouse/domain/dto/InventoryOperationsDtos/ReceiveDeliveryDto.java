package com.example.warehouse.domain.dto.InventoryOperationsDtos;
...
public class ReceiveDeliveryDto {
    ...
    @NotNull(message = "Supplier Id cannot be null", groups = {OnCreate.class})
    @Positive(message = "Supplier Id must be a positive integer", groups = {OnCreate.class})
