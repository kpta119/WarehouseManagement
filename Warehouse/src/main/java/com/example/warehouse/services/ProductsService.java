...
public class ProductsService {
    ...
    public ProductsService(ProductRepository productRepository, ProductInventoryRepository productInventoryRepository, TransactionProductRepository transactionProductRepository, CategoryRepository categoryRepository, Clock clock, ProductMapper productMapper) {
